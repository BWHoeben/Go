...
import Project.Errors.VersionsDoNotMatchException;
...
public class ClientHandler extends Thread {
	...
	public void announce() throws IOException {
		...
		if (!split[3].equals(Protocol.VERSIONNUMBER)) {
			try {
				throw new VersionsDoNotMatchException("Versions do not match!");
	...
	public Settings getSettings(int size) throws IOException {
		sendMessage(Protocol.START + Protocol.DELIMITER1 +
